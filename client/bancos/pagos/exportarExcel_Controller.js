...
angular.module("contabm").controller('BancosPagosExportarExcel_Controller',
...
function ($scope, $modalInstance, $modal, $meteor, ciaSeleccionada) {
    ...
    $scope.selectedFile = "pagos.xlsx";
    $scope.downLoadLink = "";

    $scope.exportarAExcel = (file) => {
        $scope.showProgress = true;

        $meteor.call('bancos.pagos.exportarAExcel', ciaSeleccionada)
            .then(
            function (data) {
